-- Value Clobber Tracer Test  
-- Systematically traces what operation replaces correct values with incorrect ones
-- Designed to identify the exact contamination injection point

print("===== Value Clobber Tracer Test =====")

-- Helper function to trace current state
function trace_state(stage, detail)
